				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<TR>
								<TD class=manageHead>当前位置：联系人管理 &gt; <s:property value="#linkMan==null?'联系人列表':'添加联系人'" /></TD>
							</TR>
							<TR>
								<TD height=2></TD>
							</TR>
											...
											<TBODY>
												<TR>
													...
													<TD>
														...
														style="WIDTH: 80px" maxLength=50 name="lkm_name"  value="<s:property value="#linkMan.lkm_name" />">
													</TD>
													<TD>客户ID：</TD>
													<TD>
													<input type="hidden" name="customer.cust_id" id="cust_id">
													<INPUT class=textbox style="WIDTH: 80px" maxLength=50  id="cust_name">
														<input type="button" value="选择" onclick="window.open('${pageContext.request.contextPath}/CustomerAction_list?select=true','','width=800,height=400')">
													</TD>
													<TD>
									...
									<TD><SPAN id=pagelink>
											<DIV
												...
												<select name="pageSize" onchange="changePageSize($('#pageSizeSelect option:selected').val())" id="pageSizeSelect" >
													...
													<option value="5" <s:property value="#pageBean.pageSize==5?'selected':''" /> >4</option>
												</select>
												条

...
<script type="text/javascript" src="${pageContext.request.contextPath }/js/my.js"></script>
	...
	<script type="text/javascript">
			...
			$(document).ready(function(){
				loadSelect("006","level","cust_level.dict_id","23");
				loadSelect("002","industry","cust_industry.dict_id","7");
				loadSelect("001","source","cust_source.dict_id","1");
				});
	</script>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								...
								<td>客户级别 ：</td>
								<td id="level" value="<s:property value="#customer.cust_level" />">
								</td>
							</TR>
							...
							<TR>
								...
								<td>信息来源 ：</td>
								<td id="industry" value="<s:property value="#customer.cust_industry" />">
								</td>
								<td>客户行业：</td>
								<td id="source" value="<s:property value="#customer.cust_source" />">
								</td>
							</TR>
